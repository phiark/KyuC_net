    ...
    *,
    ...
    lines.extend(
        [
            ...
            f"- secondary_pair_auroc: `{(matched_summary.secondary_pair_auroc if matched_summary.secondary_pair_auroc is not None else matched_summary.weighted_pair_auroc):.6f}`",
            ...
            f"- secondary_pair_name: `{matched_summary.secondary_pair_name or matched_summary.weighted_pair_name}`",
